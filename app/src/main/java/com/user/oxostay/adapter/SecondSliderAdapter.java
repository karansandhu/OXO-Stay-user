...
public class SecondSliderAdapter extends
        SliderViewAdapter<SecondSliderAdapter.SliderAdapterVH> {

    private Context context;
    private List<String> mSliderItems = new ArrayList<>();

    public SecondSliderAdapter(Context context) {
    ...
    @Override
    public SecondSliderAdapter.SliderAdapterVH onCreateViewHolder(ViewGroup parent) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.image_slider_layout_item, null);
        return new SecondSliderAdapter.SliderAdapterVH(inflate);
    }

    @Override
    public void onBindViewHolder(SecondSliderAdapter.SliderAdapterVH viewHolder, final int position) {
